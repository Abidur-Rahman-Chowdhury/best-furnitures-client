    ...
    return (
        <div>
            <div className='img-container border p-4 rounded-lg'>
                ...
                <button className='bg-[#6C63FF] px-2 py-1 mt-4 mr-2 text-white font-bold' onClick={()=>navigateToUpdateStock(_id)}>Update Stocks</button> 
                <button className='bg-[#338A71] px-2 py-1 mt-4 mr-2 text-white font-bold'onClick={ addMyItems} >Add My Items</button>
                </div>
            </div>
